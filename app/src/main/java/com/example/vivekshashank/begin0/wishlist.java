...
public class wishlist extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbref = FirebaseDatabase.getInstance().getReference().child("users").child(fauth.getCurrentUser().getDisplayName().toString()).child("wishlist");
        re = (RecyclerView) findViewById(R.id.rcv1);
        re.setLayoutManager(new LinearLayoutManager(this));
        re.setHasFixedSize(true);
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);
        navigationView.setNavigationItemSelectedListener(this);
        final ProgressDialog progressdialog = new ProgressDialog(wishlist.this);
